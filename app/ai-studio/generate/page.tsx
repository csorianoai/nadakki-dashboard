  ...
  return (
    <div className="ndk-page ndk-fade-in">
      <NavigationBar backHref="/ai-studio">
        <StatusBadge status="active" label="Content Generator" size="lg" />
      </NavigationBar>
      ...
      <motion.div initial={{ opacity: 0, y: -20 }} animate={{ opacity: 1, y: 0 }} className="mb-8">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-3xl font-bold text-white">Generador de Contenido</h1>
            <p className="text-gray-400">Crea contenido optimizado para cualquier plataforma con IA</p>
          </div>
        </div>
      </motion.div>
          ...
          <GlassCard className="p-6">
            ...
            >
              {generating ? (
                ...
                <><Sparkles className="w-5 h-5" /> Generar 3 Variantes</>
              )}
            </motion.button>
          </GlassCard>
        </div>
                ...
                >
                  {results?.map((result, i) => (
                    <motion.div
                      ...
                      className="p-5 bg-white/5 border border-white/10 rounded-xl hover:border-purple-500/30 transition-colors"
                    >
