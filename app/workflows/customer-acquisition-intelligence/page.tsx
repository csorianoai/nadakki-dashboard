...
export default function WorkflowcustomeracquisitionintelligencePage() {
  ...
  const executeWorkflow = async () => {
    ...
    setResult(null);
    try {
      const response = await fetch("https://nadakki-ai-suite.onrender.com/workflows/customer-acquisition-intelligence", {
        method: "POST",
  ...
  return (
    <div style={{ padding: 40, backgroundColor: "#0a0f1c", minHeight: "100vh" }}>
      <div style={{ marginBottom: 32 }}>
        <h1 style={{ fontSize: 32, fontWeight: 800, color: "#f8fafc", margin: 0 }}>🎯 Customer Acquisition</h1>
        <p style={{ color: "#94a3b8", marginTop: 8 }}>7 pasos en este workflow</p>
      </div>
