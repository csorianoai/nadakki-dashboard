  ...
  useEffect(() => {
    const fetchCampaign = async () => {
      try {
        ...
        setError("Error al cargar campaÃ±a");
        console.error(err);
      } finally {
        setLoading(false);
      }
    ...
    return (
      <div className="flex min-h-screen items-center justify-center" style={{ backgroundColor: bgPrimary }}>
        <div className="text-center">
          <p style={{ color: textPrimary }}>{error || "CampaÃ±a no encontrada"}</p>
        ...
        <div className="grid grid-cols-3 gap-6">
          <div className="col-span-2 space-y-6">
            <div className="p-6 rounded-xl" style={{ backgroundColor: bgCard, border: "1px solid " + borderColor }}>
              <h2 className="font-semibold mb-4" style={{ color: textPrimary }}>InformaciÃ³n</h2>
              <div className="space-y-4">
                ...
                <div>
                  <label className="block text-sm mb-1" style={{ color: textMuted }}>DescripciÃ³n</label>
          ...
          <div className="space-y-6">
            ...
            {campaign.stats && (
              <div className="p-6 rounded-xl" style={{ backgroundColor: bgCard, border: "1px solid " + borderColor }}>
                <h2 className="font-semibold mb-4" style={{ color: textPrimary }}>EstadÃ­sticas</h2>
