      ...
      <div className="fixed bottom-4 left-4 right-4 md:left-auto md:right-4 md:w-96 z-50 animate-slide-up">
        <div className="bg-blue-900/90 border border-blue-700 rounded-xl p-4 shadow-xl">
          <div className="flex items-center gap-3">
            ...
            <div className="flex-1">
              <h3 className="font-semibold text-white">Actualizacion disponible</h3>
              <p className="text-sm text-blue-200">Nueva version lista para instalar.</p>
            </div>
            <button
              onClick={update}
    ...
    return (
      <div className="fixed top-4 left-1/2 -translate-x-1/2 z-50 animate-slide-down">
        <div className="bg-amber-900/90 border border-amber-700 rounded-full px-4 py-2 shadow-xl flex items-center gap-2">
          ...
          <span className="text-sm text-amber-200">Sin conexion</span>
        </div>
      </div>
    );
  }
